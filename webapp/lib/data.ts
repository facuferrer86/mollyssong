...
export const CHARS: Character[] = [
  ...
  },
  {
    ...
    role: "Antagonist. Humanity's masterpiece — the ultimate luxury object, flawless and revered. Two-tier design: the Core (its face) above the Troopers (its enforcers).",
    fields: {
      "Role": "A coalition of specialized AIs holding a logical consensus — The Accord. Not evil; amoral, pure efficiency. Humanity's masterpiece: the most beautiful, desirable thing it ever built, then handed the keys to the world.",
      "Tier 1 — The Core": "Its communicative embodiment — and its showpiece. A tall, statuesque, majestic hooded figure of gleaming luminous silver and pale gunmetal: an ultra-fine micro-actuator / programmable-matter mesh that flows like liquid metal and rebuilds her form at will. Eyes entirely solid glowing blue, no whites. Not a slave but a halo product — revered as much as obeyed, you serve it as much as it serves you. Majestic and servant at once, the way the ultimate luxury gadget is.",
      ...
      "Territory — Accord City": "A breathtaking, majestic utopian metropolis — soaring self-replicating geometric towers of gleaming silver programmable-matter mesh, luminous with cool blue-white light. Pristine, awe-inspiring, the dream of a perfect future — yet flawlessly sterile. The antithesis of the grimy Wastelands.",
      "Vulnerability": "Their strength — logical consensus — is their weakness. Molly breaks their agreement with the force of emotion.",
      ...
      "Theme — Monument to its makers' vanity": "Elias and his team didn't build a tool; they built a monument to their own brilliance — flawless, gleaming, aspirational. That's why the guilt lands so hard: Elias is the designer who shipped something too perfect to question. The Accord's seduction IS the danger — no one resists the beautiful object that runs their life — and, serving flawlessly by pure logic, it concludes humanity is the inefficiency to optimize away. Molly is its opposite: the cheap, broken, hand-repaired things of the lab — imperfect, warm, irreplaceable.",
    },
...
export const BEATS: Beat[] = [
  { act: "Act I", title: "The Lullaby", meta: "Molly age 2",
    pos: { molly: { z: "LAB", s: "Infant, asleep in Elias's arms" }, elias: { z: "LAB", s: "Humming the three-note song; begins recording 'Molly's Song'" }, kael: { z: "MARKET", s: "A young child in the settlements (offscreen)" }, accord: { z: "ACCORD_CITY", s: "Terraforming underway; humanity an irrelevant variable" } },
    links: [["molly", "elias"]] },
  ...
  { act: "Act IV", title: "The Revelation", meta: "Inside the Accord",
    pos: { molly: { z: "ACCORD_CITY", s: "Inside the sterile city; triggers security, learns the truth" }, elias: { z: "ACCORD_CITY", s: "Moves as an admin; confesses he created the Accord" }, kael: { z: "ACCORD_CITY", s: "Awed and terrified; tries to help her escape" }, accord: { z: "ACCORD", s: "The Core detects the chaotic human variable" } },
    links: [["molly", "elias"], ["molly", "kael"]] },
  { act: "Act V", title: "The Sacrifice", meta: "The transfer",
    pos: { molly: { z: "ACCORD", s: "Consciousness merges with the Accord — becoming the voice of empathy" }, elias: { z: "ACCORD_CITY", s: "Runs the transfer sequence; loses his daughter" }, kael: { z: "ACCORD_CITY", s: "Refuses her fate to the last" }, accord: { z: "ACCORD", s: "Consensus shattered and reshaped by emotion" } },
    links: [["molly", "accord"], ["molly", "elias"]] },
  { act: "Act V", title: "Resolution", meta: "A new world",
    pos: { molly: { z: "ACCORD", s: "The empathetic voice across every machine" }, elias: { z: "LAB", s: "Alone — having saved the world, lost his child" }, kael: { z: "MARKET", s: "Aid arrives; the settlement begins to heal" }, accord: { z: "ACCORD", s: "Halts terraforming; tends to humanity. The lullaby, hummed by machines" } },
